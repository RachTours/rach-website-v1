const commonFormats = {
  // North America
  US: { format: "(###) ###-####", placeholder: "(201) 555-0123" },
  CA: { format: "(###) ###-####", placeholder: "(416) 555-0123" },
  MX: { format: "## ## #### ####", placeholder: "55 12 3456 7890" },

  // Europe
  GB: { format: "#### ######", placeholder: "7400 123456" },
  FR: { format: "# ## ## ## ##", placeholder: "6 12 34 56 78" },
  MA: { format: "# ## ## ## ##", placeholder: "6 12 34 56 78" },
  DE: { format: "### #######", placeholder: "151 1234567" },
  IT: { format: "### #######", placeholder: "312 1234567" },
  ES: { format: "### ### ###", placeholder: "612 345 678" },
  NL: { format: "# ########", placeholder: "6 12345678" },
  BE: { format: "### ## ## ##", placeholder: "470 12 34 56" },
  CH: { format: "## ### ## ##", placeholder: "79 123 45 67" },
  AT: { format: "### #######", placeholder: "664 1234567" },
  IE: { format: "## #######", placeholder: "87 1234567" },
  PT: { format: "### ### ###", placeholder: "912 345 678" },
  SE: { format: "## ### ## ##", placeholder: "70 123 45 67" },
  NO: { format: "### ## ###", placeholder: "400 12 345" },
  PL: { format: "### ### ###", placeholder: "500 123 456" },
  TR: { format: "### ### ## ##", placeholder: "532 123 45 67" },

  // MENA (Middle East & North Africa)
  AE: { format: "## ### ####", placeholder: "50 123 4567" },
  SA: { format: "## ### ####", placeholder: "50 123 4567" },
  QA: { format: "#### ####", placeholder: "5555 1234" },
  KW: { format: "#### ####", placeholder: "5555 1234" },
  EG: { format: "### ### ####", placeholder: "100 123 4567" },
  DZ: { format: "# ## ## ## ##", placeholder: "5 12 34 56 78" },
  TN: { format: "## ### ###", placeholder: "20 123 456" },

  // Asia
  CN: { format: "### #### ####", placeholder: "138 1234 5678" },
  IN: { format: "##### #####", placeholder: "91234 56789" },
  JP: { format: "## #### ####", placeholder: "90 1234 5678" },
  KR: { format: "## #### ####", placeholder: "10 1234 5678" },
  ID: { format: "### #### ####", placeholder: "812 3456 7890" },
  MY: { format: "## ### ####", placeholder: "12 345 6789" },
  SG: { format: "#### ####", placeholder: "8123 4567" },
  TH: { format: "## ### ####", placeholder: "81 234 5678" },
  VN: { format: "### ### ####", placeholder: "912 345 6789" },
  PH: { format: "### ### ####", placeholder: "917 123 4567" },
  PK: { format: "### #######", placeholder: "300 1234567" },

  // South America
  BR: { format: "## #####-####", placeholder: "11 91234-5678" },
  AR: { format: "## #### ####", placeholder: "11 1234 5678" },
  CO: { format: "### ### ####", placeholder: "300 123 4567" },
  CL: { format: "# #### ####", placeholder: "9 1234 5678" },

  // Oceania
  AU: { format: "### ### ###", placeholder: "412 345 678" },
  NZ: { format: "### ### ####", placeholder: "021 123 4567" },

  // Africa
  ZA: { format: "## ### ####", placeholder: "82 123 4567" },
  NG: { format: "### ### ####", placeholder: "803 123 4567" },
  KE: { format: "### ### ###", placeholder: "700 123 456" },
};
...
window.countryData = [
  ...
  { name: "American Samoa", code: "AS", dial_code: "+1", flag: "🇦🇸" },
  { name: "Andorra", code: "AD", dial_code: "+376", flag: "🇦🇩" },
  { name: "Angola", code: "AO", dial_code: "+244", flag: "🇦🇴" },
  { name: "Anguilla", code: "AI", dial_code: "+1", flag: "🇦🇮" },
  ...
  { name: "Bermuda", code: "BM", dial_code: "+1", flag: "🇧🇲" },
  ...
  { name: "British Virgin Islands", code: "VG", dial_code: "+1", flag: "🇻🇬" },
  ...
  { name: "Cayman Islands", code: "KY", dial_code: "+1", flag: "🇰🇾" },
  {
  ...
  { name: "Grenada", code: "GD", dial_code: "+1", flag: "🇬🇩" },
  { name: "Guam", code: "GU", dial_code: "+1", flag: "🇬🇺" },
  ...
  { name: "Montserrat", code: "MS", dial_code: "+1", flag: "🇲🇸" },
  ...
  { name: "Northern Mariana Islands", code: "MP", dial_code: "+1", flag: "🇲🇵" },
  ...
  { name: "Saint Kitts and Nevis", code: "KN", dial_code: "+1", flag: "🇰🇳" },
  { name: "Saint Lucia", code: "LC", dial_code: "+1", flag: "🇱🇨" },
  ...
  { name: "Sint Maarten", code: "SX", dial_code: "+1", flag: "🇸🇽" },
